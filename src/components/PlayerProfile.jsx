    ...
    <div className="player-profile">
      ...
      {tab === 'utility' && (
        <div className="player-grid">
          ...
          <article><p className="dim">Inimigos flashados</p><strong>{profile.utility.enemiesFlashed ?? 0}</strong></article>
          <article><p className="dim">Amigos flashados</p><strong>{profile.utility.teammatesFlashed ?? 0}</strong></article>
